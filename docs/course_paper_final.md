...
Построчные примеры показывают локальные типы ошибок, но постраничная проверка отвечает на другой вопрос: что происходит, если применить модель к целой странице после разбиения на фрагменты. Ниже приведены несколько характерных случаев из page-level эксперимента. Обозначения в таблице: Raw — исходный Tesseract OCR, ByT5 — модель после chunked-применения, Guard — strict guarded вариант.

| № | Страница | CER: Raw / ByT5 / Guard | WER: Raw / ByT5 / Guard | Короткий вывод |
|---:|---:|---:|---:|---|
| 1 | 50 | 0.2722 / 0.2542 / 0.2542 | 0.8721 / 0.8219 / 0.8219 | редкое улучшение |
| 2 | 38 | 0.3175 / 0.3011 / 0.3011 | 0.9073 / 0.8488 / 0.8488 | умеренное улучшение |
| 3 | 56 | 0.3400 / 0.5157 / 0.3392 | 1.1273 / 0.8970 / 1.1273 | WER лучше, CER хуже |
| 4 | 59 | 0.2982 / 0.6945 / 0.2974 | 0.8904 / 0.9726 / 0.8904 | сильное ухудшение без guard |
| 5 | 3 | 0.2448 / 0.5176 / 0.2439 | 0.8070 / 0.8363 / 0.8070 | guard предотвращает ущерб |

Случаи 1–2 показывают, что ByT5-small иногда действительно улучшает целую страницу, но масштаб улучшения остаётся умеренным. Случай 3 показывает, почему WER нельзя интерпретировать отдельно от CER: word-level метрика может улучшиться, хотя символный состав страницы ухудшается. Случаи 4–5 показывают роль strict guarded варианта: он не делает модель сильнее, но снижает риск грубого ухудшения.
