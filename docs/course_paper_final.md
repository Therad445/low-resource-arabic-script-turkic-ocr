...
Агрегированные метрики показывают общий эффект, но для real-OCR проверки важно посмотреть и на отдельные строки. Ниже приведены примеры из line-level real-OCR subset: исходный OCR-вывод Tesseract, предсказание ByT5-small и проверенный эталонный текст. Эти примеры не используются как самостоятельное доказательство качества модели; они нужны для интерпретации типов ошибок.
